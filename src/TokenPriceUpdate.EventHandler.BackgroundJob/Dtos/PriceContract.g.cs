...
namespace AElf.Contracts.Price {
    ...
    static PriceContractReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ASgFIs0BChZOZXdlc3RTd2FwUHJpY2VVcGRhdGVkEhQKDHRva2VuX3N5bWJv",
            "bBgBIAEoCRIbChN0YXJnZXRfdG9rZW5fc3ltYm9sGAIgASgJEg0KBXByaWNl",
            "GAMgASgJEi0KCXRpbWVzdGFtcBgEIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5U",
            "aW1lc3RhbXASHAoIcXVlcnlfaWQYBSABKAsyCi5hZWxmLkhhc2gSHgoWdW5k",
            "ZXJseWluZ190b2tlbl9wcmljZRgGIAEoCToEoLsYASLcAQoaTmV3ZXN0RXhj",
            "aGFuZ2VQcmljZVVwZGF0ZWQSFAoMdG9rZW5fc3ltYm9sGAEgASgJEhsKE3Rh",
            "cmdldF90b2tlbl9zeW1ib2wYAiABKAkSDQoFcHJpY2UYAyABKAkSLQoJdGlt",
            "ZXN0YW1wGAQgASgLMhouZ29vZ2xlLnByb3RvYnVmLlRpbWVzdGFtcBIpCg5w",
            "cmljZV9zdXBwbGllchgFIAEoCzIRLk9yZ2FuaXphdGlvbkxpc3QSHAoIcXVl",
            "cnlfaWQYBiABKAsyCi5hZWxmLkhhc2g6BKC7GAEy/QkKDVByaWNlQ29udHJh",
            "Y3QSOAoKSW5pdGlhbGl6ZRIQLkluaXRpYWxpemVJbnB1dBoWLmdvb2dsZS5w",
            "cm90b2J1Zi5FbXB0eSIAEjoKE1F1ZXJ5U3dhcFRva2VuUHJpY2USFS5RdWVy",
            "eVRva2VuUHJpY2VJbnB1dBoKLmFlbGYuSGFzaCIAEj4KF1F1ZXJ5RXhjaGFu",
            "Z2VUb2tlblByaWNlEhUuUXVlcnlUb2tlblByaWNlSW5wdXQaCi5hZWxmLkhh",
            "c2giABJAChRSZWNvcmRTd2FwVG9rZW5QcmljZRIOLkNhbGxiYWNrSW5wdXQa",
            "Fi5nb29nbGUucHJvdG9idWYuRW1wdHkiABJEChhSZWNvcmRFeGNoYW5nZVRv",
            "a2VuUHJpY2USDi5DYWxsYmFja0lucHV0GhYuZ29vZ2xlLnByb3RvYnVmLkVt",
            "cHR5IgASVAoYVXBkYXRlU3dhcFRva2VuVHJhY2VJbmZvEh4uVXBkYXRlU3dh",
            "cFRva2VuVHJhY2VJbmZvSW5wdXQaFi5nb29nbGUucHJvdG9idWYuRW1wdHki",
            "ABJpCihVcGRhdGVBdXRob3JpemVkU3dhcFRva2VuUHJpY2VRdWVyeVVzZXJz",
            "EiMuQXV0aG9yaXplZFN3YXBUb2tlblByaWNlUXVlcnlVc2VycxoWLmdvb2ds",
            "ZS5wcm90b2J1Zi5FbXB0eSIAEjwKDENoYW5nZU9yYWNsZRISLkNoYW5nZU9y",
            "YWNsZUlucHV0GhYuZ29vZ2xlLnByb3RvYnVmLkVtcHR5IgASTAoUQ2hhbmdl",
            "VHJhY2VQYXRoTGltaXQSGi5DaGFuZ2VUcmFjZVBhdGhMaW1pdElucHV0GhYu",
            "Z29vZ2xlLnByb3RvYnVmLkVtcHR5IgASQwoVR2V0U3dhcFRva2VuUHJpY2VJ",
            "bmZvEhsuR2V0U3dhcFRva2VuUHJpY2VJbmZvSW5wdXQaBi5QcmljZSIFiIn3",
            "AQESUwoaR2V0QmF0Y2hTd2FwVG9rZW5QcmljZUluZm8SIC5HZXRCYXRjaFN3",
            "YXBUb2tlblByaWNlSW5mb0lucHV0GgwuQmF0Y2hQcmljZXMiBYiJ9wEBEksK",
            "GUdldEV4Y2hhbmdlVG9rZW5QcmljZUluZm8SHy5HZXRFeGNoYW5nZVRva2Vu",
            "UHJpY2VJbmZvSW5wdXQaBi5QcmljZSIFiIn3AQESWwoeR2V0QmF0Y2hFeGNo",
            "YW5nZVRva2VuUHJpY2VJbmZvEiQuR2V0QmF0Y2hFeGNoYW5nZVRva2VuUHJp",
            "Y2VJbmZvSW5wdXQaDC5CYXRjaFByaWNlcyIFiIn3AQESPQoVQ2hlY2tRdWVy",
            "eUlkSWZFeGlzdGVkEgouYWVsZi5IYXNoGhEuSXNRdWVyeUlkRXhpc3RlZCIF",
            "iIn3AQESawolR2V0QXV0aG9yaXplZFN3YXBUb2tlblByaWNlUXVlcnlVc2Vy",
            "cxIWLmdvb2dsZS5wcm90b2J1Zi5FbXB0eRojLkF1dGhvcml6ZWRTd2FwVG9r",
            "ZW5QcmljZVF1ZXJ5VXNlcnMiBYiJ9wEBEkMKEUdldFRyYWNlUGF0aExpbWl0",
            "EhYuZ29vZ2xlLnByb3RvYnVmLkVtcHR5Gg8uVHJhY2VQYXRoTGltaXQiBYiJ",
            "9wEBGiyyzPYBJ0FFbGYuQ29udHJhY3RzLlByaWNlLlByaWNlQ29udHJhY3RT",
            "dGF0ZUIXqgIUQUVsZi5Db250cmFjdHMuUHJpY2ViBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::AElf.Contracts.Price.NewestSwapPriceUpdated), global::AElf.Contracts.Price.NewestSwapPriceUpdated.Parser, new[]{ "TokenSymbol", "TargetTokenSymbol", "Price", "Timestamp", "QueryId", "UnderlyingTokenPrice" }, null, null, null, null),
  ...
  public sealed partial class NewestSwapPriceUpdated : pb::IMessage<NewestSwapPriceUpdated> {
    ...
    public NewestSwapPriceUpdated(NewestSwapPriceUpdated other) : this() {
      ...
      underlyingTokenPrice_ = other.underlyingTokenPrice_;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    /// <summary>Field number for the "underlying_token_price" field.</summary>
    public const int UnderlyingTokenPriceFieldNumber = 6;
    private string underlyingTokenPrice_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public string UnderlyingTokenPrice {
      get { return underlyingTokenPrice_; }
      set {
        underlyingTokenPrice_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public bool Equals(NewestSwapPriceUpdated other) {
      ...
      if (UnderlyingTokenPrice != other.UnderlyingTokenPrice) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      ...
      if (UnderlyingTokenPrice.Length != 0) hash ^= UnderlyingTokenPrice.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (UnderlyingTokenPrice.Length != 0) {
        output.WriteRawTag(50);
        output.WriteString(UnderlyingTokenPrice);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      ...
      if (UnderlyingTokenPrice.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(UnderlyingTokenPrice);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(NewestSwapPriceUpdated other) {
      ...
      if (other.UnderlyingTokenPrice.Length != 0) {
        UnderlyingTokenPrice = other.UnderlyingTokenPrice;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 50: {
            UnderlyingTokenPrice = input.ReadString();
            break;
          }
        }
      }
